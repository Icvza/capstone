...
function footer() {
  return (
    <div>
      <div className="bg-[#f5f5f5] h-1/2 w-full flex md:flex-row flex-col justify-center item-center p-10">
        <div className="bg-[#f5f5f5] p-10">
          ...
          <div className=" bg-[#f5f5f5] flex justify-center item-center gap-8">
